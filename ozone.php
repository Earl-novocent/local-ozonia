				...
				<div class="hero-content">
					...
					<div class="carousel">
						<ul>
							...
							<li><a href="ozone.php#ozfil" rel="ozfil"><img src="images/product/ozone/ozskid.jpg" alt="ozfil" /></a></li>
							...
							<li><a href="ozone.php#dkseries" rel="dkseries"><img src="images/product/ozone/dkseries.jpg" alt="dkseries" /></a></li>
						</ul>
					</div>
				...
				<div class="carousel-content clearfix">
					<div class="cc-block active" id="general">
						...
						<div class="right">
							...
							<ul class="product-side-nav">
								...
								<li><a href="ozone.php#ozfil" rel="ozfil">OZSKID Systems</a></li>
								...
								<li><a href="ozone.php#dkseries" rel="dkseries">DK Series</a></li>
							</ul>
  						</div>
					</div><!-- end cc block -->
					...
					<div class="cc-block" id="cfs">
						<div class="left">
							...
							<p>The OZAT<sup>&reg;</sup> CFS range is ozonia<sup>&reg;</sup>'s answer for small to medium sized ozone applications. The design is based on feedback from hundreds of operators and includes the latest technology to ensure continuous operation at full load in industrial environments.</p>
					...
					<div class="cc-block" id="xf">
						<div class="left">
							...
							<p>Not only has the ozonia<sup>&reg;</sup> research team established a new calculation basis for the vessel design they have also developed a completely new dielectric technology that will compliment the phenomenally successful &ldquo;AT (Advanced Technology)&trade;&rdquo; in the larger units.</p>
							<p>The new patented technology, trademarked &ldquo;IGS&trade; (Intelligent Gap System)&rdquo;, takes ozone generation to levels never thought possible. This technological breakthrough, in conjunction with ozonia<sup>&reg;</sup>'s new <a href="ozone.php#modipac">MODIPAC&trade; power supply</a> unit, improves operating efficiency to reduce costs to the lowest possible levels.</p>
							<ul>
							...
							<div class="right">
								...
								<ul class="literature">
									<li>
										...
										<div><span>ozonia<sup>&reg;</sup> - XF&trade; Vessels</span></div>
										</a>
									</li>
								</ul>
								<h4>Applications</h4>
					...
					<div class="cc-block" id="igs">
						<div class="left">
							...
							<p>Dramatic improvement of energy efficiency from ozonia<sup>&reg;</sup>' IGS&trade; Technology reduces ozonation cost of ownership. The economic impact makes ozone an effective solution to address the ever more demanding situation.
							<ul class="igs-list">
...
<a class="lightbox ozoniaButton_small" href="media/flash/OzoneProduction_IGSTechnology.swf?lightbox[width]=850&lightbox[height]=516">IGS technology animation &raquo;</a>
					...
					<div class="cc-block" id="modipac">
						<div class="left">
							...
							<ul>
								...
								<li>The output frequency is matched to the new ozonia<sup>&reg;</sup> ozone generator technology</li>
							</ul>
						</div>
							<div class="right">
								<h4>Literature</h4>
					...
					<div class="cc-block" id="ozfil">
						<div class="left">
							<h3>OZSKID&trade; Water Treatment Systems</h3>
							<p>The OZSKID&trade; water treatment systems incorporates all of the components required to produce and apply ozone to the process water. Each skid mounted system includes an air dryer for the feed gas preparation; OZAT<sup>&reg;</sup> ozone generator; motive water pump and injector system; stainless steel contact chamber; automatic degassing valve with vent ozone destruct unit; residual ozone analyzer; flow meter; circulation bypass; control system and all skid interconnections.</p>
							<ul>
							...
							<div class="right">
								...
								<h4>Applications</h4>
								<p>The OZSKID&trade; has been designed primarily for the treatment of <a href="industrialapp.php#bottling">bottled water</a> but are ideally suited for <a href="municipalapp.php#drinking">small drinking water installations as well.</a></p>
							</div>
					</div><!-- end cc block -->
...
-->
					...
					<div class="cc-block" id="dkseries">
						<div class="left">
							<h3>DK<sup>&trade;</sup> Series</h3>

							<h4>Catalytic ozone destruct units</h4>

							<p>Off-gases containing trace levels of un-reacted ozone must be passed through a thermal or catalytic type vent ozone destruct unit before venting to the atmosphere.</p>

							<p>Catalytic ozone destruct units are meant to be used in all main applications of ozone. This includes especially:</p>
							<ul>
								<li>Drinking water treatment</li>
								<li>Industrial oxidation processes</li>
							</ul>

							<p>The DK<sup>&trade;</sup> units are also advisable for waste water applications, when the ozonation step intervenes as a final treatment.</p>
							...
							<div class="right">
								...
								<ul class="literature">
									<li>
										<a target="_blank" href="media/pdf/ozone/DK-screen.pdf">
										<img src="media/pdf/tn/ozone/dkseries.jpg" alt="DK" width="106" height="150" />
										<div><span>ozonia<sup>&reg;</sup> - DK Series</span></div>
										</a>
									</li>
								</ul>
							</div>
