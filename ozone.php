				...
				<div class="carousel-content clearfix">
					...
					<div class="cc-block" id="cfs">
						<div class="left">
							...
							<p>The OZAT<sup>&reg;</sup> CFS range is ozonia&reg;'s answer for small to medium sized ozone applications. The design is based on feedback from hundreds of operators and includes the latest technology to ensure continuous operation at full load in industrial environments.</p>
					...
					<div class="cc-block" id="xf">
						<div class="left">
							...
							<p>Not only has the ozonia&reg; research team established a new calculation basis for the vessel design they have also developed a completely new dielectric technology that will compliment the phenomenally successful &ldquo;AT (Advanced Technology)&trade;&rdquo; in the larger units.</p>
							<p>The new patented technology, trademarked &ldquo;IGS&trade; (Intelligent Gap System)&rdquo;, takes ozone generation to levels never thought possible. This technological breakthrough, in conjunction with ozonia&reg;'s new <a href="ozone.php#modipac">MODIPAC&trade; power supply</a> unit, improves operating efficiency to reduce costs to the lowest possible levels.</p>
							<ul>
							...
							<div class="right">
								...
								<ul class="literature">
									<li>
										...
										<div><span>ozonia&reg; - XF&trade; Vessels</span></div>
										</a>
									</li>
								</ul>
								<h4>Applications</h4>
					...
					<div class="cc-block" id="igs">
						<div class="left">
							...
							<p>Dramatic improvement of energy efficiency from ozonia&reg;' IGS&trade; Technology reduces ozonation cost of ownership. The economic impact makes ozone an effective solution to address the ever more demanding situation.
							<ul class="igs-list">
					...
					<div class="cc-block" id="modipac">
						<div class="left">
							...
							<ul>
								...
								<li>The output frequency is matched to the new ozonia&reg; ozone generator technology</li>
							</ul>
						</div>
							<div class="right">
								<h4>Literature</h4>
							...
							<div class="right">
								...
								<ul class="literature">
									<li>
										...
										<div><span>ozonia&reg; - DK Series</span></div>
										</a>
									</li>
								</ul>
							</div>
