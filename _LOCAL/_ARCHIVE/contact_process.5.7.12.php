...
if(!$_POST) exit;
    ...
    //$address = "mike@novocentpartners.com";    	
	...
	/* $address = ($sendto=="americas") ? "sales@ozonia.com, farchad.kaviani@degtec.com" : "Gaspar.LESZNIK@ozonia.com, farchad.kaviani@degtec.com"; */
	/* $address = ($sendto=="americas") ? "mike@novocentpartners.com" : "art@novocentpartners.com"; */
	$address="Gaspar.LESZNIK@ozonia.com, farchad.kaviani@degtec.com, sales@ozonia.com";
	...
	$phonemsg = '';
		...
		if($error != '') { 
         ...
         $email_subject = 'Email from ' .$name. ' via the Ozonia website ';
					
		 $msg  = "$name $surname filled out the contact form on the Ozonia website.\r\n\n";
		 $msg .= "Contact info ======= \r\n\n";
