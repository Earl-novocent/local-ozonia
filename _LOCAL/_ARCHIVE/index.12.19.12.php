...
<?php include('includes/common-head.php') ?>		
		...
		$(document).ready(function(){
			...
			$("#membrel-modal").click(function() {
			  var html = $('<a href="ozone.php#membrel"><img src="images/slides/modal-membrel.jpg" alt="modal-membrel" width="575" height="500" /></a>');
					...
					<div id="slider" class="slide-wrap">
						<ul>
							...
							<li class="slide">									
								...
								<img src="images/slides/wastewater.jpg" alt="Advanced Oxidation Process" class="right"/>
