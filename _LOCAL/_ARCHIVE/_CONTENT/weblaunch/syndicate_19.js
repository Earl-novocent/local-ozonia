...
syndicate.index = 0;
  syndicate.article_title[ syndicate.index ] = 'Positive Pressure Ozone Generators';
  syndicate.article_url[ syndicate.index ] = 'http://192.168.1.34:8080/weblaunch/article_40.shtml';
  syndicate.article_date[ syndicate.index ] = 'Jul  9, 2004';
  syndicate.article_summary[ syndicate.index ] = '1 to 10 Grams per hour ';
  syndicate.index++;
  syndicate.article_title[ syndicate.index ] = 'TOGC Ozone Generators';
  syndicate.article_url[ syndicate.index ] = 'http://192.168.1.34:8080/weblaunch/article_41.shtml';
  syndicate.article_date[ syndicate.index ] = 'Jul  9, 2004';
  syndicate.article_summary[ syndicate.index ] = '2 to 13 Grams per hour ';
  syndicate.index++;
  syndicate.article_title[ syndicate.index ] = 'OZAT CFS Ozone Generators';
  syndicate.article_url[ syndicate.index ] = 'http://192.168.1.34:8080/weblaunch/article_42.shtml';
  syndicate.article_date[ syndicate.index ] = 'Jul  9, 2004';
  syndicate.article_summary[ syndicate.index ] = '20 to 460 Grams per hour ';
  syndicate.index++;
  syndicate.article_title[ syndicate.index ] = 'OZAT CFV Ozone Generators';
  syndicate.article_url[ syndicate.index ] = 'http://192.168.1.34:8080/weblaunch/article_44.shtml';
  syndicate.article_date[ syndicate.index ] = 'Jul  9, 2004';
  syndicate.article_summary[ syndicate.index ] = '0.8 KG/h to 3.35 kg/h (42 lb/d to 176 lb/d) ';
  syndicate.index++;
  syndicate.article_title[ syndicate.index ] = 'Engineered Systems';
  syndicate.article_url[ syndicate.index ] = 'http://192.168.1.34:8080/weblaunch/article_46.shtml';
  syndicate.article_date[ syndicate.index ] = 'Jul  9, 2004';
  syndicate.article_summary[ syndicate.index ] = '500+ Lb/day ';
  syndicate.index++;
