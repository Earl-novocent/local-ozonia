...
syndicate.index = 0;
  syndicate.article_title[ syndicate.index ] = 'Aquaray® 40 HO and Aquaray® 3X UV Systems';
  syndicate.article_url[ syndicate.index ] = 'http://192.168.1.34:8080/weblaunch/article_62.shtml';
  syndicate.article_date[ syndicate.index ] = 'Dec 15, 2004';
  syndicate.article_summary[ syndicate.index ] = 'The Aquaray® 40 HO is the premier solution for the disinfection of waterborne pathogens in municipal wastewater. The  Aquaray® 3X System is ideally suited for large plants or plants with CSO situations.';
  syndicate.index++;
  syndicate.article_title[ syndicate.index ] = 'Aquaray® H2O UV Disinfection System';
  syndicate.article_url[ syndicate.index ] = 'http://192.168.1.34:8080/weblaunch/article_63.shtml';
  syndicate.article_date[ syndicate.index ] = 'Dec 15, 2004';
  syndicate.article_summary[ syndicate.index ] = 'An innovative new solution for the disinfection of waterborne pathogens in municipal drinking waters ';
  syndicate.index++;
  syndicate.article_title[ syndicate.index ] = 'ozonia<sup>&reg;</sup> MP Series UV Systems';
  syndicate.article_url[ syndicate.index ] = 'http://192.168.1.34:8080/weblaunch/article_64.shtml';
  syndicate.article_date[ syndicate.index ] = 'Dec 15, 2004';
  syndicate.article_summary[ syndicate.index ] = 'An extremely flexible UV system able to handle a wide range of flows with fluctuating UV transmission (clarity). ';
  syndicate.index++;
  syndicate.article_title[ syndicate.index ] = 'ozonia<sup>&reg;</sup>’s SMP Series UV systems';
  syndicate.article_url[ syndicate.index ] = 'http://192.168.1.34:8080/weblaunch/article_65.shtml';
  syndicate.article_date[ syndicate.index ] = 'Dec 15, 2004';
  syndicate.article_summary[ syndicate.index ] = 'The SMP series uses a greatly simplified control package intended for low flow applications. ';
  syndicate.index++;
