...
syndicate.index = 0;
  syndicate.article_title[ syndicate.index ] = 'Ozone as a Disinfection Solution in the Food-Stuffs Industry';
  syndicate.article_url[ syndicate.index ] = 'http://192.168.1.34:8080/weblaunch/article_10.shtml';
  syndicate.article_date[ syndicate.index ] = 'Aug  1, 2003';
  syndicate.article_summary[ syndicate.index ] = 'In the food-stuffs industry, manufacturers are being confronted with stricter legislation and demands from health-conscious consumers for higher product quality. ';
  syndicate.index++;
  syndicate.article_title[ syndicate.index ] = 'Medium-Pressure UV in Potable Water ';
  syndicate.article_url[ syndicate.index ] = 'http://192.168.1.34:8080/weblaunch/article_11.shtml';
  syndicate.article_date[ syndicate.index ] = 'Sep  1, 2003';
  syndicate.article_summary[ syndicate.index ] = 'Micro-organisms proliferating within a potable water distribution system can cause taste and odor problems, trihalomethanes and general poor health effects from water-borne pathogens. ';
  syndicate.index++;
  syndicate.article_title[ syndicate.index ] = 'Understanding residual ozone destruction';
  syndicate.article_url[ syndicate.index ] = 'http://192.168.1.34:8080/weblaunch/article_12.shtml';
  syndicate.article_date[ syndicate.index ] = 'Oct  1, 2003';
  syndicate.article_summary[ syndicate.index ] = 'Ozone, when properly applied and dissolved at the required residual concentration in water, is a very powerful and effective oxidizing and disinfecting agent. ';
  syndicate.index++;
  syndicate.article_title[ syndicate.index ] = 'Medium Pressure UV in High Purity Water Disinfection';
  syndicate.article_url[ syndicate.index ] = 'http://192.168.1.34:8080/weblaunch/article_13.shtml';
  syndicate.article_date[ syndicate.index ] = 'Nov  1, 2003';
  syndicate.article_summary[ syndicate.index ] = 'Demands of the quality of Ultra Pure Water (UPW) become more stringent as developments across the industrial market require more closely controlled quality procedures. ';
  syndicate.index++;
  syndicate.article_title[ syndicate.index ] = 'Ozone and Food Safety';
  syndicate.article_url[ syndicate.index ] = 'http://192.168.1.34:8080/weblaunch/article_14.shtml';
  syndicate.article_date[ syndicate.index ] = 'Dec  1, 2003';
  syndicate.article_summary[ syndicate.index ] = 'Ozone and the replacement of traditional sanitizing agents such as chlorine in the washing, sanitizing and storage of produce ';
  syndicate.index++;
