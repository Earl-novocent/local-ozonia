...
syndicate.index = 0;
  syndicate.article_title[ syndicate.index ] = 'Ozonia Expands Installations in China';
  ...
  syndicate.article_summary[ syndicate.index ] = 'Jiaxing,China - Ozonia Ltd. has been selected by the City of Jiaxing for the supply of a 30 kg/h (1,584 lb./day) ozone system as part of an overall upgrade to the Shijiuyang Water Treatment Plant.';
  syndicate.index++;
