					...
					<div id="slider" class="slide-wrap">
						<ul>
							...
							<li class="slide">		
								...
								<img src="images/slides/hero-aquaray-ho.jpg" alt="Advanced Oxidation Process" class="right"/>
								<h2>16 UV modules installed at Guerneville plant</h2>
								<p>New $4 million wastewater treatment unit installed at Guerneville plant</p>
								<a target="_blank" href="http://www.pressdemocrat.com/article/20120320/ARTICLES/120329970/1033/news?p=1&tc=pg" class="ozoniaButton left">Learn More</a>
							</li>						
...
<!--
							...
							<li class="slide">								
								...
								<p>The OZAT<sup>&reg;</sup> CFV ozone generators incorporate ozonia<sup>&reg;</sup>&rsquo;s patented &ldquo;Advanced Technology&rdquo; dielectric segments together with a state-of-the-art IGBT power supply unit.</p>
								<a href="ozone.php#cfv" class="ozoniaButton left">Learn More</a>
							</li>
							<li class="slide">
								<img src="images/slides/service.jpg" alt="ozonia<sup>&reg;</sup> Customer Care" class="left"/>
								<h2>Protect your process. Optimize your operation.</h2>
								<p>ozonia<sup>&reg;</sup> is committed to providing complete technical support. For any query that arises in connection with the operation of an ozonia<sup>&reg;</sup> product our service team is easily accessible and ready to help.</p>
								<a href="contact.php" class="ozoniaButton right">Contact Us</a>
