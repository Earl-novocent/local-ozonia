...
<a class="lightbox ozoniaButton_small" href="media/flash/OzoneProduction_IGSTechnology.swf?lightbox[width]=850&lightbox[height]=516">IGS technology animation &raquo;</a>		
					...
					<div class="cc-block" id="membrel">
						<div class="left">
							...
							<p>Originally developed in the early 1980's MEMBREL<sup>&reg;</sup> MKIII is Ozonia's latest generation of electrolytic ozone generators which uses solid polymer electrolyte and state-of-the-art electronics for ozone production.</p>
							...
							<div class="right">
								...
								<ul class="literature">
									<li>
										...
										<div><span>Ozonia - MEMBREL<sup>&reg;</sup> MkIII</span></div>
										</a>
									</li>
								</ul>
								<h4>Applications</h4>
