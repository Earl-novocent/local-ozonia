					...
					<div class="cc-block active" id="general">
						...
						<div class="right">
							...
							<ul class="product-side-nav">
								...
								<li><a href="ozone.php#membrel" rel="membrel">Membrel MkIII</a></li>
...
<a class="lightbox ozoniaButton_small" href="media/flash/OzoneProduction_IGSTechnology.swf?lightbox[width]=850&lightbox[height]=516">IGS technology animation &raquo;</a>		
					...
					<div class="cc-block" id="membrel">
						<div class="left">
							<h3>MEMBREL<sup>&reg;</sup> MkIII</h3>
							<p>The most effective way to disinfect Ultra Pure Water loops in industrial and pharmaceutical applications.</p>
							<p>Originally developed in the early 1980's MEMBREL<sup>&reg;</sup> MKIII is ozonia<sup>&reg;</sup>'s latest generation of electrolytic ozone generators which uses solid polymer electrolyte and state-of-the-art electronics for ozone production.</p>
							<p>Installation of a MEMBREL<sup>&reg;</sup> MKIII is an effective way of sanitizing a pure water loop. Because the ozone is produced from the water being treated there are no contaminants. The use of chemicals or additional treatment steps is not necessary.</p>
							<ul>
							...
							<div class="right">
								...
								<ul class="literature">
									<li>
										<a target="_blank" href="media/pdf/ozone/MEMBREL-screen.pdf">
										<img src="media/pdf/tn/ozone/MEMBREL-screen001.jpg" alt="MEMBREL-screen001" width="106" height="150" />
										<div><span>ozonia<sup>&reg;</sup> - MEMBREL<sup>&reg;</sup> MkIII</span></div>
										</a>
									</li>
								</ul>
								<h4>Applications</h4>
