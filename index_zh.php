					...
					<div id="slider" class="slide-wrap">
						<ul>
							...
							<li class="slide">
				    			...
				    			<!-- <p>ozonia<sup>&reg;</sup> introduces the brand new MEMBREL<sup>&reg;</sup> MkIV, a major redesign of its state-of-the-art electrolytic ozone generation system.</p> -->
				    			<p>ozonia<sup>&reg;</sup> 推出了新的 MEMBREL<sup>&reg;</sup> 系列，这是对于先进的电解水臭氧发生系统的重要创新设计。</p>
...
-->
		...
		<ul class="wrapper features">
		    ...
		    <li><a href="parts.php"><img src="images/features/service.png" alt="ozonia<sup>&reg;</sup> Customer Care" /><span>服务</span></a></li>
		</ul>
