	...
	<body class="inner-page">
		<div class="wrapper whitebg round2 shadow1">
			...
			<div class="pagecontent clearfix">
				...
				<div class="map-info">
				    <div id="map-default">
				    	<h3>ozonia<sup>&reg;</sup> International Ozone</h3>
						<ul>
				    ...
				    <div id="map-ny">
				    	<h3>ozonia<sup>&reg;</sup> North America, LLC</h3>
						<ul>
				    ...
				    <div id="map-fr">
				    	<h3>ozonia<sup>&reg;</sup> France</h3>
						<ul>
				    ...
				    <div id="map-sw">
				    	<h3>ozonia<sup>&reg;</sup> Switzerland</h3>
						<ul>
							<li>Stettbachstrasse 1</li>
							<li>8600 Duebendorf Switzerland</li>
							<li>Tel: +41 44 801 85 11</li>
				    ...
				    <div id="map-ru">
				    	<h3>ozonia<sup>&reg;</sup> Russia</h3>
						<ul>
				    ...
				    <div id="map-kr">
				    	<h3>ozonia<sup>&reg;</sup> Korea</h3>
						<ul>
				    ...
				    <div id="map-jp">
				    	<h3>ozonia<sup>&reg;</sup> Japan</h3>
						<ul>
				...
				<div class="contact-right">
				    <form class="contact-form clearfix" action="<?php $_SERVER['PHP_SELF'];?>" method="post">
				    	<h3>联系我们</h3>
				    	<table>
				    		<tr><td><label for="name" style="width:75px;">*名:</label><input name="name" type="text" /></td></tr>
				    		<tr><td><label for="surname" style="width:75px;">*姓:</label><input name="surname" type="text" /></td></tr>
				    		<tr><td><label for="company" style="width:75px;">公司:</label><input name="company" type="text" /></td></tr>
				    		<tr><td><label for="country" style="width:75px;">*国家:</label><input name="country" type="text" /></td></tr>
				    		<tr><td><label for="email" style="width:75px;">*电子邮箱:</label><input name="email" type="text" /></td></tr>
				    		<tr><td><label for="phone" style="width:75px;">电话:</label><input name="phone" type="text" /></td></tr>
				    		<tr><td><label for="message" style="width:75px;">*留言:</label><textarea name="message" ></textarea></td></tr>
				    		<input type="hidden" name="sendto" value="<?=isAmericas($_SESSION['Location']) ? "americas" : "world"; ?>" />
				    	</table>
				    	<input type="submit" class="ozoniaButton" value="联系我们"/>
				    </form>
				</div>
