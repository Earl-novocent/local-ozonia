				...
				<div class="carousel-content clearfix">
					...
					<div class="cc-block" id="disinfection">
						<div class="left">
							...
							<p>UV is a proven cost effective disinfection alternative for water and wastewater, as well as numerous industrial applications. Ozonia offers several UV products for water and wastewater treatment which are fully bioassay validated with independent third party certification per recognized regulatory guidelines.</p>
...
<div class="modalHide">
	<div id="swiss" class="clearfix">
		<div class="left">
			...
			<p>After reviewing the results, the municipality choose Ozonia to supply the full-scale plant that will be build for spring 2013. This sewage plant will be the first to comply with the new Swiss regulation on trace compounds treatment.</p>
			...
			<p>The city of D&uuml;bendorf awarded the Neugut project to OZONIA basedon the extensive know-how, experience and reliability that Ozonia is known for around the world. The Neugut sewage plant will be used as a foundation for future projects in Switzerland.</p>
...
-->
	...
	<div id="france" class="clearfix">
		<div class="left">
			...
			<p>Drawing on its know-how Ozonia offered a solution including a CFV-10 generator, allowing the sewage plant to adapt the ozone	amount to every requirement, from today to 2030, where 50 000 population equivalent are expected (840 m3/hour).</p>

			<p>With this first reference in France equipped by Ozonia, the municipality	does a forward-looking investment perfectly framing the	sustainable development.</p>
